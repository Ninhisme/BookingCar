    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3 form-group">
      ...
      <div class="card">
          <div class="card-body p-4">
              ...
              <hr/>
              <form id="myForm" class="form-body mt-4" method="POST" action="" enctype="multipart/form-data">
                @csrf     
                ...
                <div class="row">
                   ...
                   <div class="border border-3 p-4 rounded">
                    <div class="mb-3 form-group">
                        ...
                        <input type="text" name="news_title" value="{{$news->news_title}}" class="form-control" id="inputProductTitle" placeholder="Enter product title">
                      </div>
                      ...
                      <div class="mb-3 form-group">
                        ...
                        <select name="id_news_category" class="form-select" id="inputProductType">
                            ...
                            @foreach ($newsCategory as $item )
                                <option value="{{$item->id}}" {{$item->id == $news->id_news_category ? 'selected': '' }}>{{$item->news_categories_name}}</option>
                                 @endforeach
                          </select>
                      </div>
                      ...
                      <div class="mb-3 form-group">
                        ...
                        <textarea name="description"  class="form-control" id="inputProductDescription" rows="3">{{$news->description}}</textarea>
                      </div>
                       <div class="row mb-3 form-group">
                            ...
                            <div class="row mb-3 form-group">
                                ...
                                <div class="text-secondary">
                                    <img id="showImage" src="{{asset($news->thumbnail)}}" alt="Admin"  style="width: 100px; height: 100px;">
                        ...
                        <div class="mb-3 form-group">
                            ...
                            <textarea style=""  name="content" id="content" rows="3">{{$news->content}}</textarea>
                        </div>
                    </div>
                   </div>
                   <div class="col-lg-4">
                      ...
                      <div class="row g-3">
                          ...
                          <div class="col-12 form-group">
                            ...
                            <select name="status" class="form-select" id="inputVendor">
                                <option></option>
                                <option  {{$news->status === 'active' ? 'selected' : ''}} value="active">Active</option>
                                <option {{$news->status === 'inactive' ? 'selected' : ''}}  value="inactive">Inactive</option>
                            </select>
