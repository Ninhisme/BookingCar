        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Thêm loại xe</li>
                </ol>
            </nav>
        </div>
        <div class="ms-auto">
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="card">
                        ...
                        <form id="myForm" method="POST" action="{{route('car.category.store')}}" enctype="multipart/form-data">
                            @csrf
                            <div class="row mb-3">
                                <div class="col-sm-3">
                                ...
                                <div class="form-group col-sm-9 text-secondary">
                                    <input   type="text" name="car_category_name" class="form-control"  value="" />
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="form-group col-sm-9 text-secondary">
                                    <input   type="text" name="car_fare_under_30" placeholder="10.000" class="form-control"  value="" />
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="form-group col-sm-9 text-secondary">
                                    <input   type="text" name="car_fare_up_30" placeholder="10.000" class="form-control"  value="" />
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <input type="submit" class="btn btn-primary px-4" value="Thêm loại xe" />
                                </div>
                            </div>
                        </div>
